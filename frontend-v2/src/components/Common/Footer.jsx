              ...
              <div className="row">
                ...
                <div className="col-xl-3 col-lg-3 col-md-6 col-12 mb-4 mb-md-0">
                  <div className="footer-logo text-center text-md-start">
                    <Link href="/" aria-label="Rippotai Architecture Homepage">
                      <Image
                        src={footerLogo}
                        alt="Rippotai Architecture Logo"
                        width={150} // Matches your original width
                        height={50} // Matches your original height
                        className="img-fluid"
                        priority // Optional: faster load for footer logo
                      />
                    </Link>
                  </div>
                </div>
            ...
            <div className="row">
              <div className="col-12">
                <p className="text-center mb-0">
                  © {currentYear} Rippotai Architecture. All Rights Reserved
                  {" | "}
                  Designed by{" "}
                  <a
