  ...
  return (
    <>
      ...
      >
        ...
        >
          <div
            style={{
              overflow: 'hidden',
              maxWidth: phoneHovered ? '160px' : '0px',
      ...
      {showScrollTop && (
        <button
          onClick={scrollToTop}
          onMouseEnter={() => setScrollTopHovered(true)}
          onMouseLeave={() => setScrollTopHovered(false)}
          ...
          style={{
            ...
            transform: scrollTopHovered ? 'scale(1.08)' : 'scale(1)',
