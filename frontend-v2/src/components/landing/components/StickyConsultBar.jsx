...
export default function StickyConsultBar() {
  ...
  return (
    <div
      className="fixed left-0 right-0 z-50 bottom-0"
      style={{
    ...
    >
      ...
      <div className="grid grid-cols-2 bg-white">
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 py-4 text-white bg-[#1A3C34] active:bg-[#143029] transition-all"
        >
          <Phone size={18} />
        ...
        <a
          ...
          className="flex items-center justify-center gap-2 py-4 text-[#1A3C34] bg-white active:bg-[#f2f2f2] transition-all border-l border-[#1A3C3420]"
        >
