...
export const heroImages = ["./assets/1.jpeg", "./assets/2.png", "./assets/3.jpeg", "./assets/4.png"];
/************************************
 * VALUES SLIDER
 ************************************/
export const values = [
...
export const contactInfo = {
  address: "487/64, National Market, Peeragarhi, Paschim Vihar, New Delhi, Delhi 110087",
...
export const processSteps = [
  {
    id: 1,
    title: "CONSULTATION",
    description: "Understanding context, constraints, and client vision to define architectural direction.",
    icon: "/assets/icons/process_briefing.png",
  },
  {
    id: 2,
    title: "DESIGN",
    description: "Translating vision into spatial concepts through rigorous design exploration and iteration.",
  ...
  },
  {
    id: 4,
    title: "HANDOVER",
    description: "Final delivery ensuring every detail meets the uncompromising standard of our practice.",
...
export const services = [
  {
    ...
    offerings: [
      {
        ...
        description: "Thoughtfully planned layouts that optimize space, movement, and usability from the ground up.",
      },
      {
      ...
      },
      {
        ...
        description: "Carefully curated material palettes aligned with the overall architectural intent.",
      },
      {
        title: "Renovation & Transformation",
        description: "Reimagining existing spaces with a refined approach, improving both function and aesthetics.",
      },
      {
    ...
    process: [
      ...
      },
      {
        ...
        description: "3D views and design presentations help you fully visualize the space before moving forward.",
      },
      {
        step: "05",
        title: "Working Drawings",
    ...
    offerings: [
      {
        ...
        description: "Efficient layouts that optimize movement, usability, and spatial balance.",
      },
      {
        title: "Concept Design",
        description: "Defining the overall look, mood, and identity of the space with a clear design direction.",
      },
      {
        title: "3D Visualization",
        description:
      ...
      },
      {
        ...
        description: "Custom-designed elements that integrate seamlessly into the overall composition.",
      },
      {
        title: "Lighting Design",
        description: "Layered lighting strategies that enhance mood, functionality, and spatial depth.",
      },
      {
        title: "Working Drawings",
        description: "Detailed execution drawings ensuring clarity on-site and precise implementation.",
      },
    ],
    ...
    process: [
      {
        ...
        description: "We study your lifestyle, functional needs, and spatial requirements to build a clear foundation.",
      },
      {
        step: "02",
        title: "Concept Development",
        description: "Design ideas are translated into layouts and visual directions defining the space.",
      },
      {
        step: "03",
        title: "Design Detailing",
        description: "Refinement of materials, furniture, lighting, and proportions to create a cohesive design.",
      },
      {
        step: "04",
        title: "Visualization & Approval",
        description: "3D views and presentations help finalize the design with complete clarity.",
      },
      {
        step: "05",
        title: "Working Drawings",
        description: "Preparation of detailed drawings for smooth and accurate execution on-site.",
      },
      {
        step: "06",
        title: "Execution Coordination",
        description: "Support during execution to ensure the design is built as intended.",
      },
    ],
...

  {
    ...
    offerings: [
      ...
      },
      {
        ...
        description: "Wardrobes, kitchens, storage systems, and paneling designed as part of the architecture.",
      },
      {
        title: "Loose Furniture Design",
        description: "Sofas, tables, beds, and chairs crafted to complement the overall design language.",
      },
      {
        title: "Material & Finish Selection",
        description:
      ...
      },
      {
        ...
        description: "Furniture that is not just visually refined but also comfortable and practical in daily use.",
      },
      {
        title: "Detailing & Joinery Design",
        description: "Precision in joints, edges, finishes, and construction ensuring quality at every level.",
      },
      {
        title: "Execution & Vendor Coordination",
        description: "Working closely with craftsmen and vendors to ensure the design is built exactly as intended.",
      },
    ],
    process: [
      {
        step: "01",
        title: "Requirement Understanding",
        description: "We study the space, usage, and specific needs to define the purpose of each furniture element.",
      },
      {
        step: "02",
      ...
      },
      {
        step: "03",
        title: "Design Detailing",
        description: "Dimensions, materials, finishes, and joinery are finalized with precision.",
      },
      {
        step: "04",
        title: "Visualization & Approval",
        description: "3D views or detailed drawings help you clearly understand the final outcome.",
      },
      {
        step: "05",
        title: "Working Drawings",
        description: "Technical drawings are prepared for accurate fabrication and execution.",
      },
      {
        step: "06",
        title: "Production & Execution",
        description: "Coordination with vendors and on-site supervision to ensure quality and accuracy.",
      },
    ],
  ...
  },
  {
    ...
    offerings: [
      ...
      },
      {
        ...
        description: "Execution of core construction with a focus on strength, accuracy, and long-term durability.",
      },
      {
      ...
      },
      {
        ...
        description: "Integrated planning and execution of all technical systems to ensure efficiency and reliability.",
      },
      {
        title: "Material Procurement & Management",
        description: "Sourcing and managing quality materials with control over timelines, costs, and consistency.",
      },
      {
        title: "Vendor & Site Coordination",
        description: "Handling multiple vendors, timelines, and workflows to maintain smooth and organized execution.",
      },
      {
        title: "Quality Control & Supervision",
        description: "Continuous on-site monitoring to ensure every detail is built as designed.",
      },
    ],
    ...
    process: [
      ...
      },
      {
        ...
        description: "Detailed cost planning and resource allocation to align expectations with execution realities.",
      },
      {
        step: "03",
      ...
      },
      {
        ...
        description: "End-to-end execution with dedicated supervision, ensuring work progresses as per plan.",
      },
      {
        step: "05",
      ...
      },
      {
        ...
        description: "Final finishing, detailing, and project delivery — ready for immediate use.",
      },
    ],
...
export const teamMembers = [
  ...
  },
  {
    ...
    image: "https://media.cmtradingco.com/rippotai_projects/rippotai_images/priyanka.jpeg",
  },
  {
    id: 5,
    name: "Megha Chhabra",
...
export const API_URL =
  process.env.NODE_ENV === "production" ? "https://api-v2.rippotaiarchitecture.com/api" : "http://localhost:5000/api";
